...
Relationship of users to posts is a *ONE TO MANY RELATIONSHIP*. One user can have multiple posts but posts will only have one user. In user class, `db.relationship('Post', backref='author', lazy=True)`.
